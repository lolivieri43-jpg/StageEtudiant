        ...
        <div className="flex-1 min-w-0 pr-20">
          ...
          <div className="flex flex-wrap gap-1.5 text-xs">
            ...
            <Badge variant="secondary" className="rounded-full bg-violet-50 text-violet-700 border-0">
              <MapPin className="w-3 h-3 mr-1" />{offer.city}{offer.country && offer.country !== "France" && (
                <span className="ml-1 text-[10px] font-bold text-emerald-700 bg-emerald-50 rounded px-1.5 py-0.5 uppercase">{offer.country}</span>
              )}{offer._distance_km !== undefined && (
                <span className="ml-1 text-[10px] text-slate-500">· {offer._distance_km} km</span>
              )}
            </Badge>
